...
def checa_vetor4(v: np.ndarray) -> None:
    ...
    """
    if v.shape != (4, 1):
        raise ValueError('O vetor deveria ser (4,1)')
...
def checa_matriz33(m: np.ndarray) -> None:
    ...
    """
    if m.shape != (3, 3):
        raise ValueError('A matriz deveria ser (3,3)')
...
def checa_matriz44(m: np.ndarray) -> None:
    ...
    """
    if m.shape != (4, 4):
        raise ValueError('A matriz deveria ser (4,4)')
